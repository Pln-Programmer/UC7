...
export default class VendaController{
    ...
    static async Criar(req, res){
        try {
            const {veiculo_id, cliente_id, vendedor_id, valor_final, data_venda, forma_pagamento, status, obsercacoes} = req.body

            if(!veiculo_id || !cliente_id || !vendedor_id || !valor_final || !data_venda || !forma_pagamento || !status || !obsercacoes){
            ...
            const novaVenda = await VendaModel.Criar({ veiculo_id, cliente_id, vendedor_id, valor_final, data_venda, forma_pagamento, status, obsercacoes })
    ...
    static async Atualizar(req, res){
        try {
            ...
            const VendaAtualizada = await VendaModel.Atualizar(id, { veiculo_id, cliente_id, vendedor_id, valor_final, data_venda, forma_pagamento, status, obsercacoes })
